...
class DartList(Resource):
    def get(self):
        ...
        if corpcls == 'all' and code == 'all':
            result_list = list(mongodb.find_items({}, DBName, "dart_publication").sort([("rcept_dt", pymongo.DESCENDING), ("rcept_no", pymongo.DESCENDING)]))
            ...
            if code == 'all':
                ...
                result_list = list(mongodb.find_items({"stock_code":code}, DBName, "dart_publication").sort([("rcept_dt", pymongo.DESCENDING), ("rcept_no", pymongo.DESCENDING)]))
        else:
